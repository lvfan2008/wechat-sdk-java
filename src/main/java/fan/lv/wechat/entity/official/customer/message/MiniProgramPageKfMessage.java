...
@Data
@NoArgsConstructor
public class MiniProgramPageKfMessage extends BaseKfMessage {
    /**
     * 发送类型
     */
     ...
     */
    public MiniProgramPageKfMessage(String title, String appId, String pagePath, String thumbMediaId) {
        this.miniProgramPage = new MiniProgramPage(title, appId, pagePath, thumbMediaId);
    }
